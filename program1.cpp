//this file runs the first case of programming assingment 1 (bottom up dynamic programming approach)
//this file contains a main function and a struct called "boxy"
